...
export default function ControlBar({ isPlaying, handlePlay, handleRewind, handleForward }) {
    return (
        <Box style={{position: 'absolute', display: "flex", left: '50%', top: '48px', transform: 'translate(-50%,0)'}}>
